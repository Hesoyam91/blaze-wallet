"""
Django settings for blaze_wallet project.
...
WSGI_APPLICATION = 'blaze_wallet.wsgi.application'
...
#CSRF_TRUSTED_ORIGINS = ['https://blaze-wallet.azurewebsites.net','http://127.0.0.1', 'http://localhost'],
